...
objects which "support computation" \subsubsection{$\lambda$-calculus} Instead
of capturing directly the notion of computability, Alonzo Church's formalisation
was focused on formalising more precisely the notion of a function.  Church's
formulation, the $\lambda$-calculus \cite{church1932set}, is a formal system
consisting of the operations of abstraction and application using variable
binding and substitution. Church showed that the $\lambda$-calculus had an
notion of $\lambda$-definability \cite{church1936unsolvable} which was
equivalent to the class of general recursive functions \cite{kleene1936general}
as defined by G{\"o}del and clarified by Kleene, another model of computation.
Church also provided a negative answer to the \ent. The $\lambda$-calculus has
applications beyond that of providing a negative answer to the \ent.
...
notion of equivalence under $\beta$-reduction which will be referred to
\todo{maybe}
...
current state.  \todo{intuitionistic logic} $\lambda$-calculus as a deductive
system Y-combinator and curry's paradox the simply typed lambda calculus
...
Church extended their logical systems with types giving typed combinatory logic
...
specific type system named the Curry-Howard correspondence.

\todo{Intuinistic logic and constructivity. bhk interpretation}
...
Framework and  Agda, the proof-assistant used within this thesis. An analysis of
