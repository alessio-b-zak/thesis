...
aerow provides a distinguished morphsim for each object implicitly and
...
constitues a solution to the triple.
...
confirming the existence of a point surjective funtion between two objects
...
In order to push this morphism back through the point-surjective morphism.
\verb|g| needs to be turned into a point to the exponential object.
